...
//   FaTwitter,
// } from "react-icons/fa";
import social1 from "../../assets/footer/SocialLink1.png";
import social2 from "../../assets/footer/SocialLink2.png";
import social3 from "../../assets/footer/SocialLink3.png";
import social4 from "../../assets/footer/SocialLink4.png";
import social5 from "../../assets/footer/SocialLink5.png";
import leftImage from "../../assets/footer/footerLeftImage.svg";
import rightImage from "../../assets/footer/footerrightImage.svg";
import star1 from "../../assets/footer/footerstar1.svg";
import star2 from "../../assets/footer/footerstar2.svg";
import star3 from "../../assets/footer/footerstar3.svg";
import star4 from "../../assets/footer/footerstar4.svg";
import { landingUrl } from "../../config/keys";
const Footer = () => {
  return (
    <div className="footer-section">
      <span class="footerLeftImage">
        <img src={leftImage} alt="..." />
      </span>
      <span class="footerrightImage">
        <img src={rightImage} alt="..." />
      </span>
      <span class="footerstar1">
        <img src={star1} alt="..." />
      </span>
      <span class="footerstar2">
        <img src={star2} alt="..." />
      </span>
      <span class="footerstar3">
        <img src={star3} alt="..." />
      </span>
      <span class="footerstar4">
        <img src={star4} alt="..." />
      </span>
        ...
        <div className="footer-Grid">
          <div className="footer-logo">
            ...
            <div className="footer-descp">
              {/* <h4>ACE POKER</h4> */}
              <p>
                app.acepoker.io - Deposit and Withdraw with Crypto, and Share
                50% of Profits with Holders
              </p>
            </div>
          </div>
          <div className="footer-links">
            ...
            <ul>
              ...
              <li>
                <a
                  href={`${landingUrl}/privacy-policy-2/`}
                  target="_blank"
