        ...
        <div className="chat-header">
          ...
          >
            ...
            <span className="chat-author">
              <img
                src={
                  singleUsername && !singleUserProfile
                    ? userimg
                    : singleUsername && singleUserProfile
                    ? singleUserProfile
                    : userimg
              ...
              <>
                ...
                {allFriends &&
                  allFriends.map((el) => (
                    <li
                      role="presentation"
                      onClick={() => handleChooseFriend(el?.id, el?.username)}
                    >
        ...
        {chatMessages?.length ? (
          chatMessages
            ...
            ?.map((chat) => (
              <div
                className={`msg ${
                  chat?.sender?.id === user?.id ? "right-msg" : "left-msg"
                }`}
              >
                ...
                <div className="msg-bubble">
                  <div className="msg-info">
                    ...
                    <div className="msg-info-time">
                      {timeDifference(chat?.createdAt) === -1
                        ? 1
                        : timeDifference(chat?.createdAt)}
                    </div>
                  </div>
